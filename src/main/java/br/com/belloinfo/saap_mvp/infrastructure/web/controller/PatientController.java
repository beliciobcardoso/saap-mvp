...
public class PatientController {
    ...
    @GetMapping
    public ResponseEntity<PageResponseDTO<PatientResponseDTO>> listAllActive(
            @RequestParam(defaultValue = "0") int page,
            @RequestParam(defaultValue = "20") int size) {
        return ResponseEntity.ok(PageResponseDTO.from(listActivePatientsUseCase.execute(page, size), mapper::toResponse));
    }
