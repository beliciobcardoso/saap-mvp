...
class ConfirmAppointmentByTokenUseCaseTest {
    ...
    private ConfirmAppointmentByTokenUseCase useCase;
    ...
    @BeforeEach
    void setUp() {
        useCase = new ConfirmAppointmentByTokenUseCase(appointmentRepository, tokenService);
    }
    ...
    @Test
    @DisplayName("confirma agendamento com token válido e status pending_response")
    void execute_validToken_confirmsAppointment() {
    ...
    @Test
    @DisplayName("lança exceção quando a ação do token não é confirm")
