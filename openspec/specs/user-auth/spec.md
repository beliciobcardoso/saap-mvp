...
## Purpose
Esta especificação define os requisitos de negócio e cenários para a autenticação e autorização de usuários no SAAP, incluindo o login via tokens JWT (JSON Web Tokens) e o controle de acesso baseado em papéis (RBAC) nas rotas da API.
## Requirements
