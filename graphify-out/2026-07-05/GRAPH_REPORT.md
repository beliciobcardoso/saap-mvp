...
## Corpus Check
- 348 files · ~238,179 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3366 nodes · 6537 edges · 382 communities (286 shown, 96 thin omitted)
...
- `ConfirmAppointmentByTokenUseCase` --references--> `AppointmentActionTokenService`  [EXTRACTED]
  src/main/java/br/com/belloinfo/saap_mvp/application/usecase/ConfirmAppointmentByTokenUseCase.java → src/main/java/br/com/belloinfo/saap_mvp/application/service/AppointmentActionTokenService.java
...
## Communities (382 total, 96 thin omitted)

### Community 0 - "Execute Java Setup"
Cohesion: 0.11
Nodes (19): CancelAppointmentUseCaseTest, BeforeEach, DisplayName, ExtendWith, Test, UUID, CompleteAppointmentUseCaseTest, BeforeEach (+11 more)

### Community 1 - "Java Uuid Localdatetime"
Cohesion: 0.12
Nodes (22): AppointmentEntity, AllArgsConstructor, Builder, Entity, Getter, LocalDateTime, Long, NoArgsConstructor (+14 more)

### Community 2 - "String Java Blacklist"
Cohesion: 0.06
Nodes (46): AtomicInteger, AuthenticationConfiguration, CorsConfigurationSource, EnableMethodSecurity, EnableWebSecurity, HttpSecurity, OncePerRequestFilter, SecurityFilterChain (+38 more)

### Community 3 - "Mappscorrectly Toresponse Java"
Cohesion: 0.19
Nodes (17): AppointmentController, GetMapping, HttpServletRequest, PostMapping, PreAuthorize, PutMapping, RequestMapping, RequiredArgsConstructor (+9 more)
...
Cohesion: 0.15
Nodes (12): String, NotificationService, Component, Logger, RequiredArgsConstructor, String, Transactional, TriggerFollowUpUseCase (+4 more)

### Community 9 - "Java Uuid Requiredargsconstructor"
Cohesion: 0.17
Nodes (15): GetMapping, HttpServletRequest, PostMapping, PreAuthorize, PutMapping, RequestMapping, RequiredArgsConstructor, ResponseEntity (+7 more)

### Community 10 - "Cancelappointmentbytokenusecase Java String"
Cohesion: 0.33
Nodes (5): AppointmentRepository, List, LocalDateTime, Optional, UUID
...
Cohesion: 0.12
Nodes (22): DeleteMapping, GetMapping, HttpServletRequest, PostMapping, PreAuthorize, PutMapping, RequestMapping, RequiredArgsConstructor (+14 more)
...
Cohesion: 0.10
Nodes (23): CallNextPatientUseCase, RequiredArgsConstructor, String, Transactional, UUID, AuditLogWithEmail, Component, RequiredArgsConstructor (+15 more)

### Community 15 - "String Updatemedicalrecordentryrequestdto Java"
Cohesion: 0.07
Nodes (32): String, LoginRequestDTO, String, UpdateMedicalRecordEntryRequestDTO, String, AuditIntegrationTest, BeforeEach, MockMvc (+24 more)
...
Cohesion: 0.12
Nodes (20): AuthenticationException, DataIntegrityViolationException, Exception, ExceptionHandler, IllegalArgumentException, JsonInclude, MethodArgumentNotValidException, RestControllerAdvice (+12 more)

### Community 19 - "Serviceentity Java String"
Cohesion: 0.08
Nodes (28): Component, List, Optional, Override, RequiredArgsConstructor, String, UUID, ServiceRepositoryAdapter (+20 more)

### Community 20 - "Java Uuid Confirmappointmentusecase"
Cohesion: 0.15
Nodes (19): Appointment, AllArgsConstructor, Builder, Getter, LocalDateTime, Long, NoArgsConstructor, Setter (+11 more)
...
Cohesion: 0.14
Nodes (17): EntityNotFoundException, GetMedicalRecordByPatientUseCase, RequiredArgsConstructor, Transactional, UUID, AllArgsConstructor, Builder, Getter (+9 more)

### Community 23 - "Waitlistentryentity Java Localdatetime"
Cohesion: 0.06
Nodes (45): WaitlistStatus, Component, List, LocalDateTime, Optional, Override, RequiredArgsConstructor, UUID (+37 more)
...
Cohesion: 0.12
Nodes (18): JpaRepository, AllArgsConstructor, Builder, Entity, Getter, LocalDateTime, Long, NoArgsConstructor (+10 more)
...
Cohesion: 0.08
Nodes (21): Date, IllegalStateException, PostConstruct, UUID, ActionToken, Component, ConfigurationProperties, Logger (+13 more)
...
Cohesion: 0.14
Nodes (10): DeactivateUserUseCase, UUID, ListActiveUsersUseCase, List, Optional, String, UUID, UserRepository (+2 more)

### Community 35 - "Java Paginationsupport Listauditlogsusecase"
Cohesion: 0.13
Nodes (11): List, PageResult, Function, Page, Pageable, PaginationSupport, BeforeEach, DisplayName (+3 more)

### Community 36 - "Java Auditlogcontroller List"
Cohesion: 0.14
Nodes (17): LocalDateTime, AuditLogController, GetMapping, PreAuthorize, RequestMapping, RequiredArgsConstructor, ResponseEntity, RestController (+9 more)
...
Cohesion: 0.21
Nodes (6): CreatePatientUseCase, DeactivatePatientUseCase, UUID, UUID, UpdatePatientUseCase, PatientRepository
...
Cohesion: 0.11
Nodes (22): Component, EntityManager, Optional, Override, RequiredArgsConstructor, UUID, MedicalRecordRepositoryAdapter, AllArgsConstructor (+14 more)
...
Cohesion: 0.16
Nodes (7): CreateProfessionalUseCase, DeactivateProfessionalUseCase, UUID, ListActiveProfessionalsUseCase, UUID, UpdateProfessionalUseCase, ProfessionalRepository

### Community 44 - "Java Uuid Patient"
Cohesion: 0.13
Nodes (13): AllArgsConstructor, Builder, Getter, LocalDate, LocalDateTime, NoArgsConstructor, Setter, String (+5 more)
...
Cohesion: 0.26
Nodes (8): AppointmentActionTokenService, String, AcceptWaitlistOfferUseCase, Component, Logger, RequiredArgsConstructor, String, Transactional

### Community 48 - "Createuserusecase Execute Java"
Cohesion: 0.23
Nodes (8): CreateUserUseCase, PasswordEncoder, CreateUserUseCaseTest, BeforeEach, DisplayName, ExtendWith, PasswordEncoder, Test

### Community 49 - "Execute Deactivatepatientusecase Java"
Cohesion: 0.20
Nodes (9): RuntimeException, String, ResourceNotFoundException, DeactivatePatientUseCaseTest, BeforeEach, DisplayName, ExtendWith, Test (+1 more)
...
Cohesion: 0.15
Nodes (16): AuditService, RequiredArgsConstructor, String, Transactional, UUID, AuthController, AuthenticationManager, HttpServletRequest (+8 more)
...
Cohesion: 0.18
Nodes (13): CheckInAppointmentUseCase, RequiredArgsConstructor, String, Transactional, UUID, PaymentMethod, PriorityLevel, BookAppointmentRequestDTO (+5 more)

### Community 58 - "Save Coremapper Java"
Cohesion: 0.25
Nodes (4): CoreMapper, Mapper, Mapping, UUID
...
Cohesion: 0.12
Nodes (17): AllArgsConstructor, Builder, Getter, LocalDateTime, NoArgsConstructor, Setter, String, UUID (+9 more)
...
Cohesion: 0.15
Nodes (7): DomainEntitiesTest, Test, BeforeEach, ExtendWith, MockMvc, Test, ProfessionalControllerTest
...
### Community 73 - "Patientrepositoryadapter Java Component"
Cohesion: 0.29
Nodes (7): Component, Optional, Override, RequiredArgsConstructor, String, UUID, PatientRepositoryAdapter
...
Cohesion: 0.27
Nodes (5): AppointmentControllerTest, BeforeEach, ExtendWith, MockMvc, Test
...
Cohesion: 0.33
Nodes (6): DeactivateUserUseCaseTest, BeforeEach, DisplayName, ExtendWith, Test, UUID
...
Cohesion: 0.14
Nodes (14): Component, Logger, RequiredArgsConstructor, Transactional, ProcessMissedDeadlinesUseCase, ClinicSettings, Component, ConfigurationProperties (+6 more)
...
Cohesion: 0.33
Nodes (6): BeforeEach, DisplayName, ExtendWith, Test, UUID, UpdateServiceUseCaseTest
...
Cohesion: 0.29
Nodes (4): BeforeEach, Test, Transactional, ProcessMissedDeadlinesUseCaseIntegrationTest
...
Cohesion: 0.53
Nodes (4): CompleteAppointmentUseCase, RequiredArgsConstructor, Transactional, UUID
...
## Knowledge Gaps
- **886 isolated node(s):** `@kilocode/plugin`, `@opencode-ai/plugin`, `br.com.belloinfo:saap-mvp`, `The Stance`, `What You Might Do` (+881 more)
...
- **Why does `Service` connect `Java Createserviceusecase Execute` to `String Java Blacklist`, `Java Transactional Acceptwaitlistofferusecase`, `Java String Component`, `Java String Patientcontroller`, `Java Uuid Auditlog`, `Serviceentity Java String`, `Java Uuid Confirmappointmentusecase`, `Test Beforeeach Transactional`, `Java Uuid Getmedicalrecordbypatientusecase`, `CompleteAppointmentUseCase.java`, `UpdateUserUseCase`, `Java Execute Transactional`, `Securityproperties Getexpiration Getsecret`, `Waitlistentry Java Localdatetime`, `Java Deactivateuserusecase Execute`, `Opsx Explore`, `Java Auditlogcontroller List`, `Createpatientusecase Java Updatepatientusecase`, `Execute Startappointmentusecase Java`, `Createprofessionalusecase Java Execute`, `Appointmentactiontokenservice Java Appointmentactiontokenservicetest`, `Createuserusecase Execute Java`, `Findprofessionalbyidusecase Execute Java`, `Finduserbyidusecase Execute Java`, `Execute Listappointmentsusecase Java`, `Authcontroller Java Loginresponsedto`, `Java Localdatetime Bookappointmentusecase`, `Callnextpatientusecase Java Execute`, `Save Coremapper Java`, `Execute Listactivepatientsusecase Java`, `Transitionto Appointmentdomaintest Shouldallowcancellationfrompendingandconfirmedandarrived`, `Execute Confirmappointmentusecasetest Confirmssuccessfully`, `Findpatientbyidusecase Findpatientbyidusecasetest Execute`, `Execute Createserviceusecasetest Java`, `Appointmentpubliccontrollerintegrationtest Java Setup`, `Waitlistpubliccontrollerintegrationtest Java Beforeeach`, `Findappointmentbyidusecasetest Execute Java`, `Findservicebyidusecasetest Execute Java`, `Appointmentconcurrencyintegrationtest Aftereach Java`, `Waitlisttimeoutscheduler Expire Java`, `ProcessMissedDeadlinesUseCaseIntegrationTest.java`, `Findservicebyidusecase Java Execute`?**
  _High betweenness centrality (0.076) - this node is a cross-community bridge._
- **Why does `User` connect `Userrepositoryadapter Java Component` to `Execute Java Setup`, `String Java Blacklist`, `Java String Uuid`, `Java String Patientcontroller`, `String Updatemedicalrecordentryrequestdto Java`, `Test Beforeeach Transactional`, `UpdateUserUseCase`, `Securityproperties Getexpiration Getsecret`, `Java Deactivateuserusecase Execute`, `Java Paginationsupport Listauditlogsusecase`, `Java Auditlogcontroller List`, `Createuserusecase Execute Java`, `Finduserbyidusecase Execute Java`, `Save Coremapper Java`, `Execute Deactivateuserusecasetest Java`, `Appointmentpubliccontrollerintegrationtest Java Setup`, `Waitlistpubliccontrollerintegrationtest Java Beforeeach`, `Listactiveusersusecasetest Execute Java`, `Appointmentconcurrencyintegrationtest Aftereach Java`, `Waitlisttimeoutscheduler Expire Java`, `Findservicebyidusecase Java Execute`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `Appointment` connect `Java Uuid Confirmappointmentusecase` to `Execute Java Setup`, `Java String Component`, `CancelAppointmentByTokenUseCase`, `Cancelappointmentbytokenusecase Java String`, `Java Uuid Auditlog`, `String Updatemedicalrecordentryrequestdto Java`, `CompleteAppointmentUseCase.java`, `Java Createserviceusecase Execute`, `Professional Java String`, `Java Auditlogcontroller List`, `Execute Startappointmentusecase Java`, `Java Uuid Patient`, `Appointmentactiontokenservice Java Appointmentactiontokenservicetest`, `Execute Listappointmentsusecase Java`, `Java Localdatetime Bookappointmentusecase`, `Callnextpatientusecase Java Execute`, `Save Coremapper Java`, `Execute Cancelappointmentbytokenusecasetest Throwsexception`, `Execute Confirmappointmentbytokenusecasetest Throwsexception`, `Execute Updatemedicalrecordentryusecasetest Java`, `Transitionto Appointmentdomaintest Shouldallowcancellationfrompendingandconfirmedandarrived`, `Execute Confirmappointmentusecasetest Confirmssuccessfully`, `Appointmentpubliccontrollerintegrationtest Java Setup`, `Findappointmentbyidusecasetest Execute Java`, `Waitlisttimeoutscheduler Expire Java`, `Confirmappointmentbytokenusecase Illegalstateexception Java`, `Findservicebyidusecase Java Execute`, `Openspec Propose Explore`?**
